Module.register("MMM-DailyBibleVerse", {
    ...
    getDom: function() {
      ...
      if (this.verseOfTheDay != null && this.reference != null) {
        ...
        // Now we build the reference with the translated book title
        reference = " - " + this.translate(book) + " " + chapter;
      }
  
      var wrapper = document.createElement("div");
      wrapper.style.color = this.config.textColor;       // Apply text color
      wrapper.style.textAlign = this.config.textAlignment; // Apply text alignment
